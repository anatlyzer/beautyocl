...
import emfocl.typwrapper.TypwrapperFactory;
...
public class TypwrapperPackageImpl extends EPackageImpl implements TypwrapperPackage {
	 ...
	 * @see emfocl.typwrapper.TypwrapperPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public void initializePackageContents() {
		...
		addEParameter(op, theEcorePackage.getOCLExpression(), "e1", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, theEcorePackage.getOCLExpression(), "e2", 0, 1, IS_UNIQUE, IS_ORDERED);
